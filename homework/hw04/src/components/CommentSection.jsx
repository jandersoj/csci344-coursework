      ...
      {expand ? (
        ...
        comments.map((comment) => (
          <>
            ...
            <p className="uppercase text-gray-500 text-xs">{comment.display_time}</p>
          </>
        ))
      ) : (
        ...
        <>
          {lastComment && (
            <>
              <button onClick={expandComments} className="text-sm text-blue-700 width-full ">
              ...
              <p className="uppercase text-gray-500 text-xs">{lastComment.display_time}</p>
            </>
          )}
        </>
      )}
