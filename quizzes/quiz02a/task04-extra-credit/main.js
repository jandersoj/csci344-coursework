...
const doesTermMatch = (track) => {
  if (track.name.toLowerCase().includes(searchTerm.toLowerCase())) return true;
  if (track.artist.name.toLowerCase().includes(searchTerm.toLowerCase())) return true;
  if (track.album[0].name.toLowerCase().includes(searchTerm.toLowerCase())) return true;
};
...
const showMatchingTrackss = () => {
  console.log(`Search term: ${searchTerm}`);

  // output all of the matching tracks to the screen:
