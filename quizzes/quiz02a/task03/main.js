// Write a function that generates and appends a card for each element in the tracks array (located in main.js) to the <div id="track-list"></div> element.
// Attach this function to the button’s click event. Each card should look like the one in task 2 (feel free to use the same HTML snippet),
// but the information displayed should reflect the track data.
...
const tracks = [
  {
    ...
    album: {
      ...
      image_url: "https://i.scdn.co/image/ab67616d0000b27341720ef0ae31e10d39e43ca2",
    },
  ...
  },
  {
    ...
    album: {
      ...
      name: "Boston",
      image_url: "https://i.scdn.co/image/ab67616d0000b2738c1fadcc997a65384f34d694",
    },
  ...
  },
  {
    ...
    album: {
      ...
      name: "Fearless",
      image_url: "https://i.scdn.co/image/ab67616d0000b2737b25c072237f29ee50025fdc",
    },
  ...
  },
  {
    ...
    album: {
      ...
      image_url: "https://i.scdn.co/image/ab67616d0000b2730a7d45a345534966a4ad2c39",
    },
  ...
  },
  {
    ...
    album: {
      ...
      image_url: "https://i.scdn.co/image/ab67616d0000b273234bbbad4dce31cd2950af3e",
    },
    artist: {
  ...
  },
  {
    ...
    album: {
      ...
      name: "Veneer",
      image_url: "https://i.scdn.co/image/ab67616d0000b2731017779b8f5fe0ccd77bf886",
    },
  ...
  },
  {
    ...
    album: {
      ...
      name: "Souvlaki",
      image_url: "https://i.scdn.co/image/ab67616d0000b273f6e31941d10e4819d290af41",
    },
  ...
  },
  {
    ...
    album: {
      ...
      image_url: "https://i.scdn.co/image/ab67616d0000b273ada101c2e9e97feb8fae37a9",
    },
...
// container.innerHTML = tracks.map(getTracks).join("");

function displayTracks() {
  trackList.innerHTML = ""; // Clear the track list before adding new tracks
  tracks.forEach((track) => {
    trackList.innerHTML += trackCard(track);
  });
}

document.getElementById("show-tracks").addEventListener("click", displayTracks);
